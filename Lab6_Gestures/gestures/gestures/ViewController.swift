...
//
// All images (icon, launch screen, app, and unused images) taken from Google images. Credits to LINE free stickers.
...
class ViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    //Song was a free download (for Prime members) from Amazon.
